...
const DEFAULT_SURVEY = {
    title: "استبانة حصر الاحتياجات التدريبية والمهنية",
    description: "يرجى تحديد درجة احتياجك لكل محور وفق المقياس المرفق.",
    ...
    sections: [
        {
            ...
            color: "#3b82f6",
            questions: [{ id: "s1q1", text: "", type: "rating" as const }],
        },
        {
            id: "s2",
            title: "المحور الثاني: تنفيذ الدرس",
            color: "#10b981",
            questions: [{ id: "s2q1", text: "", type: "rating" as const }],
        },
        {
            id: "s3",
            title: "المحور الثالث: التقويم والمتابعة",
            color: "#f59e0b",
            questions: [{ id: "s3q1", text: "", type: "rating" as const }],
        },
        {
            id: "s4",
            title: "المحور الرابع: الجانب السلوكي والمهاري",
            color: "#ec4899",
            questions: [{ id: "s4q1", text: "", type: "rating" as const }],
        },
        {
            id: "s5",
            title: "المحور الخامس: الإدارة الصفية وبيئة التعلم",
            color: "#8b5cf6",
            questions: [{ id: "s5q1", text: "", type: "rating" as const }],
        },
        {
            id: "s6",
            title: "المحور السادس: التعاون بين المعلم والمساعد",
            color: "#f97316",
            questions: [{ id: "s6q1", text: "", type: "rating" as const }],
        },
        {
            id: "s7",
            title: "نوع الدعم والتطوير المفضل",
            color: "#6366f1",
            questions: [
                {
                    id: "s7q1",
                    text: "التدريب والتأهيل",
                    type: "multicheck" as const,
                    options: ["ورشة عمل داخلية", "دورة تدريبية خارجية", "تعلم إلكتروني ذاتي", "مجتمع تعلم مهني", "حضور مؤتمر متخصص"],
                },
                {
                    id: "s7q2",
                    text: "الإشراف والمتابعة",
                    type: "multicheck" as const,
                    options: ["زيارة إشرافية متابعة", "ملاحظة صفية من زميل", "تدريب ميداني (Coaching)", "إشراف تشاركي مع معلم خبير", "تحليل تسجيلات صفية"],
                },
                {
                    id: "s7q3",
                    text: "الموارد والأدوات",
                    type: "multicheck" as const,
                    options: ["أدوات وموارد تعليمية", "دليل استراتيجيات التدريس", "بنك أنشطة التربية الخاصة", "نماذج تخطيط محدّثة", "مكتبة فيديوهات تعليمية"],
                },
            ],
        },
        {
            ...
            color: "#14b8a6",
            questions: [
                { id: "s8q1", text: "اكتب هنا الموضوعات أو المجالات التي تود التطور فيها", type: "textarea" as const },
            ],
        },
        {
            id: "s9",
            ...
            color: "#64748b",
            questions: [
                { id: "s9q1", text: "أي ملاحظات أو تعليقات إضافية", type: "textarea" as const },
            ],
        },
    ],
};
