    ...
    return (
        <>
            <style>{`
                ...
                .print-root h1 { font-size: 18px; margin: 0; font-weight: 900; color: #5C1523; }
                ...
                .print-root .check-mark { color: #5C1523; font-weight: 900; font-size: 14px; }
            ...
            <div className="print-root">
                ...
                {/* Basic Info */}
                <h2 style={{ background: "#5C1523", color: "white" }}>المعلومات الأساسية</h2>
                ...
                {visit.praiseText && (
                    <>
                        <h2 style={{ background: "#92400e", color: "white" }}>إطراء وشكر</h2>
                        <div className="rec-block"><p>{visit.praiseText}</p></div>
                    </>
                )}
                ...
                <div className="summary-grid">
                    ...
                    <div className="summary-card" style={{ background: "#5C15230a" }}>
                        <span style={{ color: "#5C1523" }}>المعدل العام</span>
                        <b style={{ color: "#5C1523" }}>{((visit.averageScore ?? 0) * 100).toFixed(0)}%</b>
                    </div>
                </div>
                ...
                <div className="no-print" style={{ marginTop: 20, textAlign: "center" }}>
                    <button onClick={() => window.print()} style={{ padding: "8px 24px", background: "#5C1523", color: "white", border: "none", borderRadius: 8, fontWeight: 900, cursor: "pointer" }}>
                        طباعة
                    </button>
                </div>
            </div>
